            ...
            Expanded(
              child: FirebaseAnimatedList(
                  ...
                  itemBuilder: (context, snapshot, animation, index) {
                    ...
                    final lang1 =snapshot
                        .child('Language 1')
                        .value
                        .toString();
                    final lang2 =snapshot
                        .child('Language 2')
                        .value
                        .toString();
                    final lang3 =snapshot
                        .child('Language 3')
                        .value
                        .toString();
                    final lang4 =snapshot
                        .child('Language 4')
                        .value
                        .toString();
                    if(searchFilter.text.isEmpty){
                      return Padding(
                        ...
                        ||lang1.toLowerCase().contains(searchFilter.text.toLowerCase())
                        || lang2.toLowerCase().contains(searchFilter.text.toLowerCase())
                    || lang3.toLowerCase().contains(searchFilter.text.toLowerCase())
                    || lang4.toLowerCase().contains(searchFilter.text.toLowerCase())){
                      return Padding(
                        padding: const EdgeInsets.symmetric(
                            vertical: 8, horizontal: 20),
                        child: Container(
